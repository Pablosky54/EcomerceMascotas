/**
 * Section 9: Exotic Cat Spotlight (Gato Exótico)
 * Full-bleed cat image with top black band - mirrored from dog spotlight
 */
...
export default function SectionCatSpotlight() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-screen overflow-hidden z-[18]"
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-end gap-2">
          <a
            ref={ctaRef}
            href="https://wa.me/573001234567?text=Hola,%20me%20interesa%20comprar%20un%20Gato%20Exótico"
            target="_blank"
          ...
          <p className="text-white/60 text-xs italic hidden md:block">
            Cachorros certificados · Pedigree disponible.
          </p>
        </div>
      </div>
    </section>
