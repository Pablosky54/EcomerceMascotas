/**
 * Section 8: International Shipping (Envíos Internacionales)
 * Collage left + headline right + plane badge
 */
...
export default function SectionInternational() {
  ...
  return (
    <section
      ref={sectionRef}
      id="envios"
      className="relative w-full h-screen overflow-hidden z-[17]"
    ...
    >
      ...
      >
        <div className="overflow-hidden">
          <img src="/s8_puppy_bed.jpg" alt="Cachorro en cama" className="img-cover" />
        </div>
        <div className="overflow-hidden row-span-2">
          <img src="/s8_owner_dog.jpg" alt="Dueña con perro" className="img-cover" />
        </div>
        <div className="overflow-hidden">
          <img src="/s8_dog_sofa.jpg" alt="Perro en sofá" className="img-cover" />
        </div>
      </div>
      ...
      >
        ...
        <div className="mt-8">
          <a
            href="https://wa.me/573001234567?text=Hola,%20quiero%20cotizar%20un%20envío%20internacional"
            target="_blank"
      ...
      >
        ...
        <p className="label-micro text-[var(--pp-text-secondary)] text-center max-w-[120px]">
          LOGÍSTICA INTERNACIONAL CERTIFICADA
        </p>
      </div>
    </section>
  );
